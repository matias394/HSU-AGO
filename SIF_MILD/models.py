...
class MILD_PreAdmision (models.Model):
    ...
    fk_legajo = models.ForeignKey(Legajos, related_name='MILD_fk_legajo', on_delete=models.PROTECT, null=True, blank=True)
    fk_legajo_1 = models.ForeignKey(Legajos, related_name='MILD_fk_legajo_1', on_delete=models.PROTECT, null=True, blank=True)
    fk_legajo_2 = models.ForeignKey(Legajos, related_name='MILD_fk_legajo_2', on_delete=models.PROTECT, null=True, blank=True)
    ...
    planes_sociales_1 = models.ForeignKey(PlanesSociales, related_name='MILD_planes_sociales_1', on_delete=models.PROTECT, null=True, blank=True)
    ...
    planes_sociales_2 = models.ForeignKey(PlanesSociales, related_name='MILD_planes_sociales_2', on_delete=models.PROTECT, null=True, blank=True)
    ...
    fk_legajo_3 = models.ForeignKey(Legajos, related_name='MILD_fk_legajo_3', on_delete=models.PROTECT, null=True, blank=True)
    ...
    fk_legajo_4 = models.ForeignKey(Legajos, related_name='MILD_fk_legajo_4', on_delete=models.PROTECT, null=True, blank=True)
    ...
    fk_legajo_5 = models.ForeignKey(Legajos, related_name='MILD_fk_legajo_5', on_delete=models.PROTECT, null=True, blank=True)
...
class MILD_IndiceIVI(models.Model):
    ...
    fk_preadmi = models.ForeignKey(MILD_PreAdmision, on_delete=models.PROTECT, null=True, blank=True)
...
class MILD_Admision(models.Model):
    fk_preadmi = models.ForeignKey(MILD_PreAdmision, on_delete=models.PROTECT)
