...
class MILD_PreAdmision (models.Model):
    ...
    planes_sociales_1 = models.ManyToManyField(PlanesSociales, related_name='MILD_planes_sociales_1',null=True, blank=True)
    ...
    planes_sociales_2 = models.ManyToManyField(PlanesSociales, related_name='MILD_planes_sociales_2',null=True, blank=True)
