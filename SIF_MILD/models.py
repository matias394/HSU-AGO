...
class MILD_PreAdmision (models.Model):
    ...
    acompaniante = models.ForeignKey(Usuarios, related_name='MILD_Acompaniante', on_delete=models.PROTECT, blank=True, null=True)
    madrina = models.ForeignKey(AgentesExternos, related_name='MILD_Madrina', on_delete=models.PROTECT, blank=True, null=True)
