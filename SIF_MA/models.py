...
class MA_Derivacion (models.Model):
    ...
    creado_por = models.ForeignKey(Usuarios, related_name='MA_Derivacion_creado_por', on_delete=models.CASCADE, blank=True, null=True)
    modificado_por = models.ForeignKey(Usuarios, related_name='MA_Derivacion_modificado_por', on_delete=models.CASCADE, blank=True, null=True)
...
class MA_PreAdmision (models.Model):
    fk_derivacion = models.ForeignKey(MA_Derivacion, on_delete=models.CASCADE)
    ...
    familia_abrigadora = models.CharField(max_length=250, choices=CHOICE_FAMILIA_ABRIGADORA, null=True, blank=True)
...
class MA_Admision(models.Model):
    ...
    organismo = models.CharField(max_length=250, null=True, blank=True, choices=CHOICE_ORGANISMO_ABRIGO,)
