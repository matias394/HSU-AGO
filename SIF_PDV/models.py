...
class PDV_PreAdmision (models.Model):
    ...
    fk_legajo = models.ForeignKey(Legajos, related_name='PDV_fk_legajo', on_delete=models.PROTECT, null=True, blank=True)
    fk_legajo_1 = models.ForeignKey(Legajos, related_name='PDV_fk_legajo_1', on_delete=models.PROTECT, null=True, blank=True)
    fk_legajo_2 = models.ForeignKey(Legajos, related_name='PDV_fk_legajo_2', on_delete=models.PROTECT, null=True, blank=True)
    ...
    fk_legajo_3 = models.ForeignKey(Legajos, related_name='PDV_fk_legajo_3', on_delete=models.PROTECT, null=True, blank=True)
    ...
    fk_legajo_4 = models.ForeignKey(Legajos, related_name='PDV_fk_legajo_4', on_delete=models.PROTECT, null=True, blank=True)
    ...
    fk_legajo_5 = models.ForeignKey(Legajos, related_name='PDV_fk_legajo_5', on_delete=models.PROTECT, null=True, blank=True)
...
class PDV_IndiceIVI(models.Model):
    ...
    fk_preadmi = models.ForeignKey(PDV_PreAdmision, on_delete=models.PROTECT, null=True, blank=True)
...
class PDV_Foto_Ingreso(models.Model):
    ...
    tipo = models.CharField (max_length=350, null=True, blank=True)
    clave = models.CharField (max_length=350, null=True, blank=True)
    creado_por = models.ForeignKey(Usuarios, related_name='PDV_Ingreso_creado_por', on_delete=models.PROTECT, blank=True, null=True)
    modificado_por = models.ForeignKey(Usuarios, related_name='PDV_Ingreso_modificado_por', on_delete=models.PROTECT, blank=True, null=True)
    creado = models.DateField(auto_now_add=True, null=True, blank=True)
    modificado = models.DateField(auto_now=True, null=True, blank=True)
 
class PDV_Vacantes(models.Model):
    fk_legajo = models.ForeignKey(Legajos, on_delete=models.PROTECT, null=True, blank=True)
    fk_derivacion = models.ForeignKey(PDV_PreAdmision, on_delete=models.PROTECT, null=True, blank=True)
...
class PDV_Admision(models.Model):
    fk_preadmi = models.ForeignKey(PDV_PreAdmision, on_delete=models.PROTECT)
...
class PDV_Intervenciones(models.Model):
    fk_admision = models.ForeignKey(PDV_Admision, on_delete=models.PROTECT, null=True, blank=True)
