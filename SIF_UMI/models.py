...
#    #creado_por = models.ForeignKey(Usuarios, related_name='UMI_creado_por', on_delete=models.CASCADE, blank=True, null=True)
#    #modificado_por = models.ForeignKey(Usuarios, related_name='UMI_modificado_por', on_delete=models.CASCADE, blank=True, null=True)
...
class UMI_PreAdmision (models.Model):
    ...
    fk_legajo = models.ForeignKey(Legajos, related_name='UMI_fk_legajo', on_delete=models.CASCADE, null=True, blank=True)
    fk_legajo_1 = models.ForeignKey(Legajos, related_name='UMI_fk_legajo_1', on_delete=models.CASCADE, null=True, blank=True)
    fk_legajo_2 = models.ForeignKey(Legajos, related_name='UMI_fk_legajo_2', on_delete=models.CASCADE, null=True, blank=True)
    ...
    planes_sociales_1 = models.ForeignKey(PlanesSociales, related_name='UMI_planes_sociales_1', on_delete=models.CASCADE, null=True, blank=True)
    ...
    planes_sociales_2 = models.ForeignKey(PlanesSociales, related_name='UMI_planes_sociales_2', on_delete=models.CASCADE, null=True, blank=True)
    ...
    fk_legajo_3 = models.ForeignKey(Legajos, related_name='UMI_fk_legajo_3', on_delete=models.CASCADE, null=True, blank=True)
    ...
    fk_legajo_4 = models.ForeignKey(Legajos, related_name='UMI_fk_legajo_4', on_delete=models.CASCADE, null=True, blank=True)
    ...
    fk_legajo_5 = models.ForeignKey(Legajos, related_name='UMI_fk_legajo_5', on_delete=models.CASCADE, null=True, blank=True)
    ...
    acompaniante = models.ForeignKey(Usuarios, related_name='UMI_Acompaniante', on_delete=models.CASCADE, blank=True, null=True)
    madrina = models.ForeignKey(AgentesExternos, related_name='UMI_Madrina', on_delete=models.CASCADE, blank=True, null=True)
    ...
    creado_por = models.ForeignKey(Usuarios, related_name='UMI_PreAdm_creado_por', on_delete=models.CASCADE, blank=True, null=True)
    modificado_por = models.ForeignKey(Usuarios, related_name='UMI_PreAdm_modificado_por', on_delete=models.CASCADE, blank=True, null=True)
...
class UMI_IndiceIVI(models.Model):
    ...
    fk_preadmi = models.ForeignKey(UMI_PreAdmision, on_delete=models.CASCADE, null=True, blank=True)
...
class UMI_Foto_IVI(models.Model):
    ...
    tipo = models.CharField (max_length=350, null=True, blank=True)
    clave = models.CharField (max_length=350, null=True, blank=True)
    creado_por = models.ForeignKey(Usuarios, related_name='UMI_IVI_creado_por', on_delete=models.CASCADE, blank=True, null=True)
    modificado_por = models.ForeignKey(Usuarios, related_name='UMI_IVI_modificado_por', on_delete=models.CASCADE, blank=True, null=True)
    creado = models.DateField(auto_now_add=True, null=True, blank=True)
    modificado = models.DateField(auto_now=True, null=True, blank=True)
...
class UMI_Foto_Ingreso(models.Model):
    ...
    tipo = models.CharField (max_length=350, null=True, blank=True)
    clave = models.CharField (max_length=350, null=True, blank=True)
    creado_por = models.ForeignKey(Usuarios, related_name='UMI_Ingreso_creado_por', on_delete=models.CASCADE, blank=True, null=True)
    modificado_por = models.ForeignKey(Usuarios, related_name='UMI_Ingreso_modificado_por', on_delete=models.CASCADE, blank=True, null=True)
    creado = models.DateField(auto_now_add=True, null=True, blank=True)
    modificado = models.DateField(auto_now=True, null=True, blank=True)
...
class UMI_Admision(models.Model):
    fk_preadmi = models.ForeignKey(UMI_PreAdmision, on_delete=models.CASCADE)
    estado = models.CharField(max_length=150, null=True, blank=True, default="Activa")
    creado = models.DateField(auto_now_add=True, null=True, blank=True)
    modificado = models.DateField(auto_now=True, null=True, blank=True)
    creado_por = models.ForeignKey(Usuarios, related_name='UMI_Admision_creado_por', on_delete=models.CASCADE, blank=True, null=True)
    modificado_por = models.ForeignKey(Usuarios, related_name='UMI_Admision_modificada_por', on_delete=models.CASCADE, blank=True, null=True)
...
class UMI_Intervenciones(models.Model):
    fk_admision = models.ForeignKey(UMI_Admision, on_delete=models.CASCADE, null=True, blank=True)
    ...
    creado = models.DateField(auto_now_add=True, null=True, blank=True)
    modificado = models.DateField(auto_now=True, null=True, blank=True)
    creado_por = models.ForeignKey(Usuarios, related_name='UMI_Intervenciones_creado_por', on_delete=models.CASCADE, blank=True, null=True)
    modificado_por = models.ForeignKey(Usuarios, related_name='UMI_Intervenciones_modificada_por', on_delete=models.CASCADE, blank=True, null=True)
