...
class UMI_PreadmisionesForm (forms.ModelForm):
    class Meta:
...
class UMI_IndiceIngresoForm (forms.ModelForm):
    class Meta:
        model = UMI_IndiceIngreso
        fields = '__all__'
        widgets = {}
        labels = {}

class UMI_IndiceIngresoHistorialForm (forms.ModelForm):
    class Meta:
        model = UMI_Foto_Ingreso
        fields = '__all__'
        widgets = {}
        labels = {}
...
class UMI_IndiceIviForm (forms.ModelForm):
    class Meta:
        model = UMI_IndiceIVI
        fields = '__all__'
        widgets = {}
...
class UMI_IndiceIviHistorialForm (forms.ModelForm):
    class Meta:
        model = UMI_Foto_IVI
        fields = '__all__'
        widgets = {}
...
class UMI_IntervencionesForm (forms.ModelForm):
    class Meta:
...
class UMI_OpcionesResponsablesForm (forms.ModelForm):
    class Meta:
