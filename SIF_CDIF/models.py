...
class CDIF_PreAdmision (models.Model):
    ...
    cual_enfermedad = models.CharField(max_length=100, null=True, blank=True, verbose_name="¿Cual?")
    en_tratamiento = models.CharField(max_length=100, choices=CHOICE_NOSI, null=True, blank=True,verbose_name="¿En tratamiento?")
    donde_tratamiento = models.CharField(max_length=100,  null=True, blank=True,verbose_name="¿Donde?",choices=CHOICE_CENTROS_SALUD)
