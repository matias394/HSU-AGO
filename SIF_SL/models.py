...
class SL_Expedientes (models.Model):
    ...
    fk_equipo = models.ForeignKey(SL_Equipos, on_delete=models.CASCADE, null=True, blank=True)
    creado_por = models.ForeignKey(Usuarios, related_name='SL_Expediente_creado_por', on_delete=models.CASCADE, blank=True, null=True)
    modificado_por = models.ForeignKey(Usuarios, related_name='SL_Expediente_modificado_por', on_delete=models.CASCADE, blank=True, null=True)
...
class SL_PreAdmision (models.Model):
    fk_derivacion = models.ForeignKey(LegajosDerivaciones, on_delete=models.CASCADE, null=True, blank=True)
    fk_expediente = models.ForeignKey(SL_Expedientes, on_delete=models.CASCADE)
...
class SL_GrupoFamiliar(models.Model):
    fk_expediente = models.ForeignKey(SL_Expedientes, on_delete=models.CASCADE)
    fk_legajo_familiar = models.ForeignKey(Legajos, on_delete=models.CASCADE, null=True, blank=True)

class SL_Alarmas(models.Model):
    fk_expediente = models.ForeignKey(SL_Expedientes, on_delete=models.CASCADE)
    fk_alarmas = models.ForeignKey(Alertas, on_delete=models.CASCADE, null=True, blank=True)

class SL_Referentes(models.Model):
    fk_expediente = models.ForeignKey(SL_Expedientes, on_delete=models.CASCADE)
    fk_legajo_referente = models.ForeignKey(Legajos, on_delete=models.CASCADE, null=True, blank=True)
    fk_externo = models.ForeignKey(AgentesExternos, on_delete=models.CASCADE, null=True, blank=True)
...
class SL_EquipoDesignado(models.Model):
    fk_equipo = models.ForeignKey(SL_Equipos, on_delete=models.CASCADE)
    fk_expediente = models.ForeignKey(SL_Expedientes, on_delete=models.CASCADE)
    fk_preadmi = models.ForeignKey(SL_PreAdmision, on_delete=models.CASCADE)
    fk_admi = models.ForeignKey(SL_Admision, on_delete=models.CASCADE)
    creado_por = models.ForeignKey(Usuarios, related_name='SL_EquipoDesignado_creado_por', on_delete=models.CASCADE, blank=True, null=True)
    modificado_por = models.ForeignKey(Usuarios, related_name='SL_EquipoDesignado_modificado_por', on_delete=models.CASCADE, blank=True, null=True)
    creado = models.DateField(auto_now_add=True, null=True, blank=True)
    modificado = models.DateField(auto_now=True, null=True, blank=True)
    
class SL_IndiceVulnerabilidad(models.Model):
    fk_indice = models.ForeignKey(SL_IndicesVulnerabilidad, on_delete=models.CASCADE, null=True, blank=True)
    ...
    creado_por = models.ForeignKey(Usuarios, related_name='SL_IndiceVulnerabilidad_creado_por', on_delete=models.CASCADE, blank=True, null=True)
    modificado_por = models.ForeignKey(Usuarios, related_name='SL_IndiceVulnerabilidad_modificado_por', on_delete=models.CASCADE, blank=True, null=True)
    creado = models.DateField(auto_now_add=True, null=True, blank=True)
    modificado = models.DateField(auto_now=True, null=True, blank=True)
