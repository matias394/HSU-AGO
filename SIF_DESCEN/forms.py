...
class DESCEN_IndiceIviForm (forms.ModelForm):
    class Meta:
        model = DESCEN_IndiceIVI
        fields = '__all__'
        widgets = {}
        labels = {}

class DESCEN_IndiceIviHistorialForm (forms.ModelForm):
    class Meta:
        model = DESCEN_Foto_IVI
        fields = '__all__'
        widgets = {}
        labels = {}
...
class DESCEN_VacantesOtorgadasForm (forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['fk_organismo'].queryset = Vacantes.objects.filter(fk_programa=settings.PROG_DESCEN)

class DESCEN_IntervencionesForm (forms.ModelForm):
...
class DESCEN_OpcionesResponsablesForm (forms.ModelForm):
    class Meta:
